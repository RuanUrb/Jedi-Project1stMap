...
class Fase0 extends Phaser.Scene{
    constructor(){
        super('Phase0')
    }
...
// função para criação dos elementos
    ...
    {   
        ...
        this.nextPhase = this.add.zone(786, 650).setSize(50, 70)
        this.physics.world.enable(this.nextPhase)
        ...
        this.dialogs = new dialogs0(this);   
...
// update é chamada a cada novo quadro
    ...
    // trata zona ativa
    checkActiveZone(){
        if(this.physics.overlap(this.player, this.nextPhase)){
            this.scene.stop()
            this.bgm.stop()

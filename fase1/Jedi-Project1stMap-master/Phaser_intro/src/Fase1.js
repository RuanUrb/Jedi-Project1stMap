...
// função para criação dos elementos
    ...
    {   
        ...
        // criação do rei
        this.player = this.physics.add.sprite(player_pos.x, player_pos.y, 'player_sp', 0);
        ...
        this.physics.add.collider(this.player, this.meilin, ()=> {
            this.meilin.body.setImmovable(true)
            this.meilin.setVelocity(0)
        })
